...
//clients
const ClientsTable = React.lazy(() => import("./views/clients/table/ClientTable"))
...
const routes = [
  ...
  { path: "/clientstable", name: "Table of clients", element: ClientsTable },
  { path: "/clientstable/:clientName", name: "Details", element: DetailsTable },
